...
import { IssueTicketListRelationFilter } from "../../issueTicket/base/IssueTicketListRelationFilter";
...
class AppUserWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => IssueTicketListRelationFilter,
  })
  @ValidateNested()
  @Type(() => IssueTicketListRelationFilter)
  @IsOptional()
  @Field(() => IssueTicketListRelationFilter, {
    nullable: true,
  })
