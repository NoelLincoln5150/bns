...
@InputType()
class ContractCreateNestedManyWithoutSuppliersItemsInput {
...
export { ContractCreateNestedManyWithoutSuppliersItemsInput as ContractCreateNestedManyWithoutSuppliersItemsInput };
