...
@InputType()
class DocumentPaymentsUpdateManyWithoutPaymentTypesItemsInput {
...
export { DocumentPaymentsUpdateManyWithoutPaymentTypesItemsInput as DocumentPaymentsUpdateManyWithoutPaymentTypesItemsInput };
