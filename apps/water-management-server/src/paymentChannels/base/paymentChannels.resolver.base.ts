...
import { CreatePaymentChannelsArgs } from "./CreatePaymentChannelsArgs";
import { UpdatePaymentChannelsArgs } from "./UpdatePaymentChannelsArgs";
...
export class PaymentChannelsResolverBase {
  ...
  async createPaymentChannels(
    @graphql.Args() args: CreatePaymentChannelsArgs
  ): Promise<PaymentChannels> {
  ...
  async updatePaymentChannels(
    @graphql.Args() args: UpdatePaymentChannelsArgs
  ): Promise<PaymentChannels | null> {
    try {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => PaymentTypes, {
    nullable: true,
    name: "paymentType",
  })
  @nestAccessControl.UseRoles({
  ...
  async getPaymentType(
    @graphql.Parent() parent: PaymentChannels
  ): Promise<PaymentTypes | null> {
    const result = await this.service.getPaymentType(parent.id);
