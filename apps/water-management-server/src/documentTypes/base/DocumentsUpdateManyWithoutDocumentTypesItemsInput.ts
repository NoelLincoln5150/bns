...
@InputType()
class DocumentsUpdateManyWithoutDocumentTypesItemsInput {
...
export { DocumentsUpdateManyWithoutDocumentTypesItemsInput as DocumentsUpdateManyWithoutDocumentTypesItemsInput };
