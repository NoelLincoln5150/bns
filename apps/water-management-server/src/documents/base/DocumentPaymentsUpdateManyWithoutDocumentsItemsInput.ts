...
@InputType()
class DocumentPaymentsUpdateManyWithoutDocumentsItemsInput {
...
export { DocumentPaymentsUpdateManyWithoutDocumentsItemsInput as DocumentPaymentsUpdateManyWithoutDocumentsItemsInput };
